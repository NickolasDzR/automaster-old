/*!
 * modernizr v3.10.0
 * Build https://modernizr.com/download?-arrow-contains-cssanimations-es5-es5array-es5date-es5function-es5object-es5string-es5syntax-es5undefined-es6array-es6collections-es6math-es6number-es6object-es6string-flexbox-flexbox-generators-placeholder-promises-strictmode-svg-webp-setclasses-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
